...
<template>
    <div>
        <Dialog header="Cpu Type" v-model:visible="displayModal" @hide="closeModal" :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
            ...
            <template #footer>
                ...
                <Button label="Add Item" icon="pi pi-check" @click="submitCpuType" class="blue-bg text-white"
                    autofocus />
            </template>
        </Dialog>
        <!-- <Toast /> -->
