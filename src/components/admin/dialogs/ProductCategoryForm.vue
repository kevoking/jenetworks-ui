...
<template>
    <div>
        <Dialog header="Product Category" v-model:visible="displayModal" :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
            ...
            <template #footer>
                ...
                <Button label="Add Item" icon="pi pi-check" @click="submitProductCategory" class="bg-indigo-600 text-white"
                    autofocus />
            </template>
        </Dialog>
        <!-- <Toast /> -->
