...
<template>
    <div>
        <Dialog header="Operating System" v-model:visible="displayModal" :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
            ...
            <template #footer>
                ...
                <Button label="Add Item" icon="pi pi-check" @click="submitOperating" class="bg-indigo-600 text-white"
                    autofocus />
            </template>
        </Dialog>
        <!-- <Toast /> -->
